...
export const dictZh: Dict = {
  ...
  about_title: '关于本站',
  about_intro_html:
    '本站由 <a href="https://github.com/chenlinzhuo/video-to-notebook">video-to-notebook</a> 生成 —— 抓取公开课、用 Claude 打概念标签、跨课程渲染概念页。',
...
export const dictEn: Dict = {
  ...
  about_intro_html:
    'This site was generated by <a href="https://github.com/chenlinzhuo/video-to-notebook">video-to-notebook</a> — it crawls open-courseware, tags it with Claude, and renders cross-course concept pages.',
