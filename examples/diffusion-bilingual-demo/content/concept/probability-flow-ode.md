---
canonical_name: Probability Flow ODE
description: Deterministic ODE whose marginals match the SDE; enables exact likelihood
  and fast sampling.
...
Deterministic ODE whose marginals match the SDE; enables exact likelihood and fast sampling.

**55 occurrences** across courses:

- **cmu-10799-diffusion-flow** L9 (CMU 10799 S26: Lecture 10 - Distillation, Consistency Models & Flow Maps - Diffusion & Flow Matching) @ 3004s — OD or PD or whatever um and then the
flow maps because we also look at ODEs flow maps because we also look at ODEs flow 
