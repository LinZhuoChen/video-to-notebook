---
canonical_name: Simple Loss
description: The MSE-on-epsilon objective from DDPM that drops VLB weighting and works
  in practice.
...
The MSE-on-epsilon objective from DDPM that drops VLB weighting and works in practice.
