...
description: Trick to trade diversity for sample quality by extrapolating between
...
Trick to trade diversity for sample quality by extrapolating between conditional and unconditional predictions.

**85 occurrences** across courses:
